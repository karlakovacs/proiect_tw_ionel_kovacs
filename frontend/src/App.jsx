        ...
        <Router>
            <Routes>
                ...
                <Route path="/student/:id" element={<Dashboard />}>
                    ...
                    <Route path="trimitere-cerere/:idStudent/:idSesiune" element={<TrimitereCerere />} />
                ...
                <Route path="/profesor/:id" element={<Dashboard />}>
                    <Route index element={<Acasa />} />
                    <Route path="cereri-sesiune-curenta" element={<CereriSesiuneCurenta />} />
                ...
                <Route path="/cerere/:idCerere/:idStudent/:idSesiune/:idProfesor" element={<Cerere />}></Route>
