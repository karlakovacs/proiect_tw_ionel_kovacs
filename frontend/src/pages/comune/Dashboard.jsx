...
const Dashboard = () => {
    ...
    const meniuri = {
        ...
        profesor: [
            { path: `/profesor/${ID}/cereri-sesiune-curenta`, label: 'Cererile din sesiunea curentă' },
            ...
            <header>
                ...
                <nav>
                    {meniuri[tip].map((meniu, index) => (
                        <NavLink key={index} to={meniu.path} className={({ isActive }) => (isActive ? 'nav-link active' : 'nav-link')}>
                            {meniu.label}
                        </NavLink>
                    ))}

                    <NavLink to={`/${tip}/${ID}/profil`} className={({ isActive }) => (isActive ? 'nav-link active' : 'nav-link')}>
                        <FaUser title="Profil" />
                    </NavLink>
                    <NavLink to={`/${tip}/${ID}/setari`} className={({ isActive }) => (isActive ? 'nav-link active' : 'nav-link')}>
                        <FaCog title="Setări" />
                    </NavLink>
                </nav>
            </header>
