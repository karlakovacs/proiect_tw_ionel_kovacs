import "../../css_files/student/TrimitereCerere.css";
...
const TrimitereCerere = () => {
	...
	return (
		<div className="TrimitereCerere">
			<h2>Trimitere cerere</h2>
			<form onSubmit={handleSubmit}>
				<label>Titlu preliminar:</label>
				<input
					type="text"
					name="titluPreliminar"
					value={formData.titluPreliminar}
					onChange={handleChange}
				/>

				<label>Descriere preliminară:</label>
				<textarea
					name="descrierePreliminara"
					value={formData.descrierePreliminara}
					onChange={handleChange}
				></textarea>
